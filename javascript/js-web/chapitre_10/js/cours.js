...
req.open("POST", "http://localhost/projects/javascript-web-srv/post_form.php");
...
ajaxPost("http://localhost/projects/javascript-web-srv/post_form.php", commande, function(reponse) {
...
form.addEventListener("submit", function(e) {
  ...
  ajaxPost("http://localhost/projects/javascript-web-srv/post_form.php", data, function() {});
});
...
ajaxPost("http://localhost/projects/javascript-web-srv/post_json.php", film, function(reponse) {
